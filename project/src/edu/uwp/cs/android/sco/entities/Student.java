...
public class Student {
    ...
    public void addDisability(String name, String info, long studentId) {
    	Disability dis = new Disability(null, name, info, 0, id);
    ...
    public void addDefaultDisabilities() {
    	addDisability("Disability1", "Info1", id);
        addDisability("Disability2", "Info2", id);
        addDisability("Disability3", "Info3", id);
    }
