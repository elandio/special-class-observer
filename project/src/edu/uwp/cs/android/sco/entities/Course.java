...
public class Course {
    ...
    private List<RelationCourseStudent> students;
    ...
    public Course(Long id, String name, String category, String semester, int year) {
        this.id = id;
        this.name = name;
    ...
    public synchronized List<RelationCourseStudent> getStudents() {
        if (students == null) {
            if (daoSession == null) {
