...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        DisabilityDao.createTable(db, ifNotExists);
        CourseDao.createTable(db, ifNotExists);
        RelationCourseStudentDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        StudentDao.dropTable(db, ifExists);
        DisabilityDao.dropTable(db, ifExists);
        CourseDao.dropTable(db, ifExists);
        RelationCourseStudentDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(DisabilityDao.class);
        registerDaoClass(CourseDao.class);
        registerDaoClass(RelationCourseStudentDao.class);
    }
