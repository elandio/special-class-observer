...
public class StudentDao extends AbstractDao<Student, Long> {
    ...
    public static class Properties {
        ...
        public final static Property DisabilityLevel = new Property(5, Integer.class, "disabilityLevel", false, "DISABILITY_LEVEL");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        String sql = "CREATE TABLE " + (ifNotExists? "IF NOT EXISTS ": "") + "'STUDENT' (" + //
                ...
                "'DISABILITY_LEVEL' INTEGER);"; // 5: disabilityLevel
        db.execSQL(sql);
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Student entity) {
        ...
        Integer disabilityLevel = entity.getDisabilityLevel();
        if (disabilityLevel != null) {
            stmt.bindLong(6, disabilityLevel);
        }
    }
    ...
    public Student readEntity(Cursor cursor, int offset) {
        Student entity = new Student( //
            ...
            cursor.isNull(offset + 5) ? null : cursor.getInt(offset + 5) // disabilityLevel
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Student entity, int offset) {
        ...
        entity.setDisabilityLevel(cursor.isNull(offset + 5) ? null : cursor.getInt(offset + 5));
     }
